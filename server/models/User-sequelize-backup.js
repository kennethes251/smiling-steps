...
module.exports = (sequelize, DataTypes) => {
  ...
  User.failedLogin = async function(userId) {
    // DISABLED: Account lockout removed for better UX
    // Users can retry login without being locked out
    const LOCK_TIME = 15 * 60 * 1000; // 15 minutes
    const MAX_ATTEMPTS = 999; // Effectively disabled (was 5)
    ...
    // Only lock after an extremely high number of attempts (prevents brute force)
